  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
      ...
      <div className="border border-border rounded-2xl bg-surface p-6 space-y-6 relative overflow-hidden group">
        <div>
          <span className="text-[10px] font-black uppercase text-text-secondary bg-surface-elevated px-2.5 py-1 rounded border border-border">
            Audited metrics
          </span>
          <h4 className="text-lg font-black text-text-primary mt-2">{animeA_title}</h4>
          <p className="text-xs text-text-secondary mt-1">Platform-level distribution of coordinated anomalies.</p>
        </div>
        ...
        <div className="space-y-4 font-mono text-xs">
          <div className="space-y-2">
            <div className="flex justify-between text-text-secondary">
              ...
              <span className="text-danger font-bold">{stats.animeA.mal.bomberPct}% Low-Ratings</span>
            </div>
            ...
            <div className="flex justify-between text-[10px] text-text-secondary">
              <span>💣 {stats.animeA.mal.bomberPct}% Coordinated Low (1-2/10)</span>
              <span>🔥 {stats.animeA.mal.glazerPct}% Coordinated High (9-10/10)</span>
            </div>
          </div>
          ...
          <div className="space-y-2 pt-2 border-t border-border/40">
            <div className="flex justify-between text-text-secondary">
              ...
              <span className="text-accent-gold font-bold">{stats.animeA.anilist.glazerPct}% High-Ratings</span>
            </div>
            <div className="h-3 w-full bg-background rounded-full overflow-hidden flex">
            ...
            <div className="flex justify-between text-[10px] text-text-secondary">
              <span>💣 {stats.animeA.anilist.bomberPct}% Coordinated Low (1-2/10)</span>
              <span>🔥 {stats.animeA.anilist.glazerPct}% Coordinated High (9-10/10)</span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="space-y-4 font-mono text-xs">
          <div className="space-y-2">
            <div className="flex justify-between text-text-secondary">
              ...
              <span className="text-danger font-bold">{stats.animeB.mal.bomberPct}% Low-Ratings</span>
            </div>
            <div className="h-3 w-full bg-background rounded-full overflow-hidden flex">
            ...
            <div className="flex justify-between text-[10px] text-text-secondary">
              <span>💣 {stats.animeB.mal.bomberPct}% Coordinated Low (1-2/10)</span>
              <span>🔥 {stats.animeB.mal.glazerPct}% Coordinated High (9-10/10)</span>
            </div>
          </div>
          ...
          <div className="space-y-2 pt-2 border-t border-border/40">
            <div className="flex justify-between text-text-secondary">
              ...
              <span className="text-accent-gold font-bold">{stats.animeB.anilist.glazerPct}% High-Ratings</span>
            </div>
            <div className="h-3 w-full bg-background rounded-full overflow-hidden flex">
            ...
            <div className="flex justify-between text-[10px] text-text-secondary">
              <span>💣 {stats.animeB.anilist.bomberPct}% Coordinated Low (1-2/10)</span>
              <span>🔥 {stats.animeB.anilist.glazerPct}% Coordinated High (9-10/10)</span>
            </div>
          </div>
        </div>
      </div>
